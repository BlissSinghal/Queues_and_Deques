...
let test () : bool =
  let d = create () in
  insert_tail 1 d;
  remove_tail d = 1 && is_empty d && valid d
...
let test() : bool = 
  ...
  delete_last 3 d; 
  to_list d = [1;2] 
;; run_test "delete_last element not in deque" test
...
let test() : bool = 
  ...
  delete_last 2 d; 
  to_list d = [2; 1; 3]
;; run_test "delete_last multiple elements and duplicates" test
...
let test() : bool = 
  ...
  delete_first 3 d; 
  to_list d = [1;2] 
;; run_test "delete_first element not in deque" test
...
let test() : bool = 
  ...
  delete_first 2 d; 
  to_list d = [1; 3; 2]
;; run_test "delete_first multiple elements and duplicates" test
